    ...
    >
      <div className="flex h-16 w-full items-center justify-between px-10  sm:h-18 sm:px-20 lg:h-20 lg:px-40">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group inline-flex items-center gap-2 rounded-full bg-[#47a51f] px-3 py-2 text-xs font-black text-white transition duration-300 hover:-translate-y-0.5 hover:bg-[#3d8f1a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#9ed87a] focus-visible:ring-offset-4 sm:px-4 sm:text-sm"
        >
          <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
