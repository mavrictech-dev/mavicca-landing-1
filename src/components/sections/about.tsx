...
export function AboutSection() {
  return (
    <section
      id="quienes-somos"
      className="relative isolate min-h-160 overflow-hidden bg-white lg:min-h-175"
    >
      ...
      <div className="absolute inset-x-0 bottom-0 -z-10 h-20 bg-linear-to-t from-[#fbfff7] to-transparent" />
      ...
      <div className="relative z-10 mx-auto flex min-h-112.5 max-w-7xl items-start px-6 pb-4 pt-20 sm:px-10 lg:min-h-117.5 lg:px-8">
        <div className="max-w-140 space-y-8">
          <div className="space-y-6">
            <Reveal>
              <div className="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-[#55a52f] ring-1 ring-emerald-100">
            ...
            <Reveal delay={0.08}>
              <h2 className="text-[clamp(2.15rem,3vw,3.35rem)] font-black uppercase leading-none tracking-[-0.045em] text-[#08254a]">
                ¿Quiénes somos?
              </h2>
            </Reveal>
            ...
            <Reveal delay={0.16}>
              <p className="text-[clamp(1.05rem,1.35vw,1.35rem)] font-medium leading-[1.7] text-slate-900/88">
                ...
                soluciones técnicas innovadoras y <strong className="font-black text-slate-950">efectivas para el cumplimiento</strong>{" "}
          ...
          <Reveal delay={0.24} className="space-y-5">
            <a
              href="#contacto"
              className="group inline-flex items-center justify-center gap-3 rounded-lg bg-[#062b57] px-8 py-4 text-base font-semibold text-white shadow-[0_16px_34px_rgba(6,43,87,0.18)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#083968] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-4"
            >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pb-20 pt-20 sm:px-10 lg:px-8">
        <Stagger className="grid gap-5 rounded-[1.4rem] border border-emerald-100 bg-white/88 px-6 py-6 shadow-[0_18px_54px_rgba(8,37,74,0.08)] backdrop-blur-md sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
          {aboutStats.map((stat, index) => {
            ...
            return (
              <StaggerItem key={stat.label}>
                ...
                >
                  <div className="grid size-14 shrink-0 place-items-center rounded-2xl bg-emerald-50 text-[#08254a] ring-1 ring-emerald-100 transition duration-300 group-hover:bg-[#55a52f] group-hover:text-white">
                    <Icon className="size-8" strokeWidth={1.8} aria-hidden="true" />
                  </div>
                  <div>
                    <p className="text-[clamp(1.8rem,2.5vw,2.7rem)] font-black leading-none tracking-[-0.04em] text-[#08254a]">
                      {stat.value}
                    </p>
